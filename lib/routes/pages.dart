...
List<GetPage<dynamic>>? getPages = [
  ...
  GetPage(name: RoutesString.newsDetails, page: () => NewsDetails()),
  ...
  GetPage(name: RoutesString.shoppingcart, page: () => const ShoppingCart(title: '', imageAssetPath: '', author: '', pages: '', language: '', release: '', description: '',)),
  GetPage(
      ...
      page: () => const BookDetails(
            ...
            author: '',
            title: '',
            imageAssetPath: '', pages: '', language: '', release: '', description: '',
          )),
