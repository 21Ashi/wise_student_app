...
class _OpennewsectionState extends State<RequestElective> {
  final TextEditingController _entercourseid = TextEditingController();
  final TextEditingController _entersection = TextEditingController();
  ...
  String? _validateSection(String? value) {
    if (value == null || value.isEmpty) {
      ...
      return 'Course ID must be exactly 1 digits';
    }
    return null;
  }
                  ...
                  child: SizedBox(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        controller: _entersection,
                        decoration: InputDecoration(
                          hintText: S.of(context).SectionNumber,
                          hintStyle: const TextStyle(fontSize: 14),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(15),
                          ),
