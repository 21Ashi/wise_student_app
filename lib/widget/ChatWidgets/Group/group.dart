  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        onPressed: (){
          FireData().createGroup(gname.text, members).then((value) => Navigator.pop(context));
          setState((){
            members=[];
          });
        },
              ...
              Padding(
                ...
                child:TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.group_add, color: Colors.white,),
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Members",style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,),),
