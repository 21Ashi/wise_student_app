...
import 'package:wise_student_app/widget/StudentWidgets/Table/marks_report_table.dart';
import 'package:wise_student_app/widget/StudentWidgets/Table/student_hrs_table.dart';

class DroplistMarksReport extends StatefulWidget {
  const DroplistMarksReport({super.key});
...
class _DroplistSemesterState extends State<DroplistMarksReport> {
