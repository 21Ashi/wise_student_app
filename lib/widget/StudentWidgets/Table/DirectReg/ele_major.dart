...
class ElectiveMajorC extends StatefulWidget {
  const ElectiveMajorC({super.key,});

  @override
  State<ElectiveMajorC> createState() => _ElectiveMajorCState();
}

class _ElectiveMajorCState extends State<ElectiveMajorC> {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('ElectiveMajor').snapshots(),
