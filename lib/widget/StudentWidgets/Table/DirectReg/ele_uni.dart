...
class ElectiveUniversityC extends StatefulWidget {
  const ElectiveUniversityC({super.key,});

  @override
  State<ElectiveUniversityC> createState() => _ElectiveUniversityCState();
}

class _ElectiveUniversityCState extends State<ElectiveUniversityC> {
