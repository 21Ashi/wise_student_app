...
class MandatoryCollege extends StatefulWidget {
  const MandatoryCollege({super.key});

  @override
  State<MandatoryCollege> createState() => _MandatoryCollegeState();
}

class _MandatoryCollegeState extends State<MandatoryCollege> {
