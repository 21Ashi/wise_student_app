...
class ElectiveMajor extends StatefulWidget {
  const ElectiveMajor({super.key});

  @override
  State<ElectiveMajor> createState() => _ElectiveMajorState();
}

class _ElectiveMajorState extends State<ElectiveMajor> {
