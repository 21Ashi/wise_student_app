...
class MandatoryMajor extends StatefulWidget {
  const MandatoryMajor({super.key});

  @override
  State<MandatoryMajor> createState() => _MandatoryMajorState();
}

class _MandatoryMajorState extends State<MandatoryMajor> {
